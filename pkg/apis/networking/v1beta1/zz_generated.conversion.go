...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Endpoint)(nil), (*networking.Endpoint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Endpoint_To_networking_Endpoint(a.(*Endpoint), b.(*networking.Endpoint), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*networking.Endpoint)(nil), (*Endpoint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_networking_Endpoint_To_v1beta1_Endpoint(a.(*networking.Endpoint), b.(*Endpoint), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*ExternalEntityReference)(nil), (*networking.ExternalEntityReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ExternalEntityReference_To_networking_ExternalEntityReference(a.(*ExternalEntityReference), b.(*networking.ExternalEntityReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*networking.ExternalEntityReference)(nil), (*ExternalEntityReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_networking_ExternalEntityReference_To_v1beta1_ExternalEntityReference(a.(*networking.ExternalEntityReference), b.(*ExternalEntityReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*GroupMember)(nil), (*networking.GroupMember)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_GroupMember_To_networking_GroupMember(a.(*GroupMember), b.(*networking.GroupMember), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*networking.GroupMember)(nil), (*GroupMember)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_networking_GroupMember_To_v1beta1_GroupMember(a.(*networking.GroupMember), b.(*GroupMember), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_AddressGroup_To_networking_AddressGroup(in *AddressGroup, out *networking.AddressGroup, s conversion.Scope) error {
	...
	out.GroupMembers = *(*[]networking.GroupMember)(unsafe.Pointer(&in.GroupMembers))
	return nil
}
...
func autoConvert_v1beta1_AddressGroupPatch_To_networking_AddressGroupPatch(in *AddressGroupPatch, out *networking.AddressGroupPatch, s conversion.Scope) error {
	...
	out.AddedGroupMembers = *(*[]networking.GroupMember)(unsafe.Pointer(&in.AddedGroupMembers))
	out.RemovedGroupMembers = *(*[]networking.GroupMember)(unsafe.Pointer(&in.RemovedGroupMembers))
	return nil
}
...
func autoConvert_v1beta1_Endpoint_To_networking_Endpoint(in *Endpoint, out *networking.Endpoint, s conversion.Scope) error {
	out.IP = *(*networking.IPAddress)(unsafe.Pointer(&in.IP))
	out.Ports = *(*[]networking.NamedPort)(unsafe.Pointer(&in.Ports))
	return nil
}

// Convert_v1beta1_Endpoint_To_networking_Endpoint is an autogenerated conversion function.
func Convert_v1beta1_Endpoint_To_networking_Endpoint(in *Endpoint, out *networking.Endpoint, s conversion.Scope) error {
	return autoConvert_v1beta1_Endpoint_To_networking_Endpoint(in, out, s)
}

func autoConvert_networking_Endpoint_To_v1beta1_Endpoint(in *networking.Endpoint, out *Endpoint, s conversion.Scope) error {
	out.IP = *(*IPAddress)(unsafe.Pointer(&in.IP))
	out.Ports = *(*[]NamedPort)(unsafe.Pointer(&in.Ports))
	return nil
}

// Convert_networking_Endpoint_To_v1beta1_Endpoint is an autogenerated conversion function.
func Convert_networking_Endpoint_To_v1beta1_Endpoint(in *networking.Endpoint, out *Endpoint, s conversion.Scope) error {
	return autoConvert_networking_Endpoint_To_v1beta1_Endpoint(in, out, s)
}

func autoConvert_v1beta1_ExternalEntityReference_To_networking_ExternalEntityReference(in *ExternalEntityReference, out *networking.ExternalEntityReference, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
}

// Convert_v1beta1_ExternalEntityReference_To_networking_ExternalEntityReference is an autogenerated conversion function.
func Convert_v1beta1_ExternalEntityReference_To_networking_ExternalEntityReference(in *ExternalEntityReference, out *networking.ExternalEntityReference, s conversion.Scope) error {
	return autoConvert_v1beta1_ExternalEntityReference_To_networking_ExternalEntityReference(in, out, s)
}

func autoConvert_networking_ExternalEntityReference_To_v1beta1_ExternalEntityReference(in *networking.ExternalEntityReference, out *ExternalEntityReference, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
}

// Convert_networking_ExternalEntityReference_To_v1beta1_ExternalEntityReference is an autogenerated conversion function.
func Convert_networking_ExternalEntityReference_To_v1beta1_ExternalEntityReference(in *networking.ExternalEntityReference, out *ExternalEntityReference, s conversion.Scope) error {
	return autoConvert_networking_ExternalEntityReference_To_v1beta1_ExternalEntityReference(in, out, s)
}
...
// Convert_v1beta1_GroupMember_To_networking_GroupMember is an autogenerated conversion function.
func Convert_v1beta1_GroupMember_To_networking_GroupMember(in *GroupMember, out *networking.GroupMember, s conversion.Scope) error {
	return autoConvert_v1beta1_GroupMember_To_networking_GroupMember(in, out, s)
}

func autoConvert_networking_GroupMember_To_v1beta1_GroupMember(in *networking.GroupMember, out *GroupMember, s conversion.Scope) error {
...
// Convert_networking_GroupMember_To_v1beta1_GroupMember is an autogenerated conversion function.
func Convert_networking_GroupMember_To_v1beta1_GroupMember(in *networking.GroupMember, out *GroupMember, s conversion.Scope) error {
	return autoConvert_networking_GroupMember_To_v1beta1_GroupMember(in, out, s)
}
